...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['"Gothic A1"', 'Inter', 'system-ui', 'sans-serif'],
      ...
      colors: {
        ...
        lead: {
          ...
          converted: "hsl(var(--lead-converted))",
        },
        stage: {
          prospect: "hsl(var(--stage-prospect))",
          committee: "hsl(var(--stage-committee))",
          commercial: "hsl(var(--stage-commercial))",
          active: "hsl(var(--stage-active))",
          matchmaking: "hsl(var(--stage-matchmaking))",
